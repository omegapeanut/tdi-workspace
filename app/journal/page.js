    ...
    <div style={{ fontFamily: "Manrope, sans-serif", color: "#EFE7DA", background: "#221C15", minHeight: "100vh" }}>
      ...
      <div style={{ padding: "72px 64px 40px", display: "flex", flexDirection: "column", gap: "26px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          <h1 style={{ margin: 0, font: "italic 500 76px/1.05 'Cormorant Garamond', serif" }}>Know before you renovate.</h1>
      ...
      <div style={{ padding: "16px 64px 40px" }}>
        <Link
      ...
      <div style={{ padding: "0 64px 90px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "40px 22px" }}>
          {posts.map((p) => (
      ...
      <div style={{ padding: "72px 64px", borderTop: "1px solid rgba(239,231,218,.1)", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "32px", flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 0 }}>
          <input
            ...
            style={{ border: "1px solid rgba(239,231,218,.35)", borderRight: 0, background: "transparent", color: "#EFE7DA", padding: "15px 20px", font: "400 13px Manrope, sans-serif", borderRadius: "2px 0 0 2px", width: "260px", outline: "none" }}
          />
          <button style={{ border: 0, background: "oklch(0.74 0.08 78)", color: "#221C15", borderRadius: "0 2px 2px 0", padding: "15px 26px", font: "700 12px Manrope, sans-serif", letterSpacing: ".08em", cursor: "pointer" }}>
            SUBSCRIBE
          </button>
        </div>
      </div>
