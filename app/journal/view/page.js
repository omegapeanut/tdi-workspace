  ...
  return (
    <>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "56px 32px 80px", display: "flex", flexDirection: "column", gap: "28px", font: "400 16px/1.9 Manrope, sans-serif", color: "rgba(239,231,218,.78)" }}>
        ...
        <div style={{ background: "rgba(20,16,11,.5)", border: "1px solid rgba(239,231,218,.14)", borderRadius: "3px", padding: "28px 30px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "20px", marginTop: "10px" }}>
      ...
      <div style={{ padding: "64px", borderTop: "1px solid rgba(239,231,218,.1)", display: "flex", flexDirection: "column", gap: "32px" }}>
