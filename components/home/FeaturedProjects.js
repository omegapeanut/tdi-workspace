...
export default function FeaturedProjects() {
  ...
  return (
    <div style={{ padding: "0 64px 110px", display: "flex", flexDirection: "column", gap: "48px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: "32px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          <h2 style={{ margin: 0, font: "italic 500 54px/1.1 'Cormorant Garamond', serif" }}>Recent handovers.</h2>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr", gap: "22px" }}>
        {items.map((project) => (
