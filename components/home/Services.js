...
export default function Services() {
  ...
  return (
    <div style={{ padding: "110px 64px 100px", display: "flex", flexDirection: "column", gap: "56px", borderTop: "1px solid rgba(239,231,218,.1)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: "32px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          <h2 style={{ margin: 0, font: "italic 500 54px/1.1 'Cormorant Garamond', serif" }}>{servicesHeadline[mode]}</h2>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "1px", background: "rgba(239,231,218,.12)", border: "1px solid rgba(239,231,218,.12)" }}>
        {items.map((item) => (
